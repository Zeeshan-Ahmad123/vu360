...
import { MenuService } from 'src/app/shared/AppServices/Menus/menu.service';
...
export class HeadingComponent {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute,private menu:MenuService) {
    this.router.events
    .pipe(
  ...
  ngOnInit(){
    // Dynamic Menu made by Kashif
    this.menuItems=this.menu.GetCustomeMenus();
  }
}
