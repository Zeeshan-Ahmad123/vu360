    ...
    function init() {
        ...
        if (typeof Chart !== "undefined") {
                        ...
                        datasets: [
                            {
                                ...
                                data: [250, 500, 1000, 800, 1300, 1150, 1800],
                                borderColor: "white",
                                pointBackgroundColor: "white",
                                pointBorderColor: "white",
                                pointHoverBackgroundColor: themeColor5,
            ...
            if (document.getElementById("visitChart1")) {
                var visitChart = document.getElementById("visitChart1").getContext("2d");
                var myChart = new Chart(visitChart, {
                        ...
                        datasets: [
                            {
                                ...
                                data: [250, 1500, 700, 1500, 2000, 1000, 2300],
                                borderColor: "white",
                                pointBackgroundColor: "white",
                                pointBorderColor: "white",
                                pointHoverBackgroundColor: themeColor5,
            ...
            if (document.getElementById("visitChart2")) {
                var visitChart = document.getElementById("visitChart2").getContext("2d");
                var myChart = new Chart(visitChart, {
            ...
            if (document.getElementById("visitChart3")) {
                var visitChart = document.getElementById("visitChart3").getContext("2d");
                var myChart = new Chart(visitChart, {
            ...
            if (document.getElementById("visitHelpChart")) {
                var visitHelpChart = document.getElementById("visitHelpChart").getContext("2d");
                var myChart = new Chart(visitHelpChart, {
                    ...
                    data: {
                        ...
                        labels: ["25 Mar", "26 Mar", "27 Mar", "28 Mar", "29 Mar", "30 Mar", "31 Mar"],


                        datasets: [
                            {

                                data: [10, 60, 52, 120, 160, 100, 70],
                                borderColor: "white",
                                pointBackgroundColor: "white",
                                pointBorderColor: "white",
                                pointHoverBackgroundColor: themeColor5,
            ...
            if (document.getElementById("ageGroupBreakdown")) {
                var ageGroupBreakdown = document
                    .getElementById("ageGroupBreakdown")
                    .getContext("2d");
                var myChart = new Chart(ageGroupBreakdown, {
                    type: "bar",
                    options: {
                        plugins: {
                            datalabels: {
                        ...
                        datasets: [
                            {
                                ...
                                borderColor: "#383636",
                                backgroundColor: themeColor1_10,
                                data: [456, 479, 324, 569, 702, 600, 320, 250, 400, 500, 670, 700],
                                borderWidth: 2
                            },
                            {
                                label: "Female",
                                borderColor: themeColor2,
                                backgroundColor: themeColor2_10,
                                data: [364, 504, 605, 400, 345, 320, 520, 390, 200, 600, 570, 650],
                                borderWidth: 2
                            }
                        ]
                    }
        ...
        /* 03.25. Progress Analytics page */
        $(".progress-bar1").each(function () {
            $(this).css("width", $(this).attr("aria-valuenow"));
        });

        if (typeof ProgressBar !== "undefined") {
            $(".progress-bar1-circle").each(function () {
                var val = $(this).attr("aria-valuenow");
                var color = $(this).data("color") || themeColor1;
                var trailColor = $(this).data("trailColor") || "#d7d7d7";
                var max = $(this).attr("aria-valuemax") || 100;
        ...
        /* 03.25. Progress MOst visited shelves page */
        $(".progress-bar2").each(function () {
            $(this).css("width", $(this).attr("aria-valuenow"));
        });

        if (typeof ProgressBar !== "undefined") {
            $(".progress-bar2-circle").each(function () {
                var val = $(this).attr("aria-valuenow");
                var color = $(this).data("color") || themeColor1;
                var trailColor = $(this).data("trailColor") || '#d7d7d7';
